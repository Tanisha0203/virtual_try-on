...
<div id="wrapper">
  ...
  <div id="content">
    <h2><span style="color:#42222A"> <?php echo $_SESSION['Name'];?>'s cart items</span></h2>
    <table width="100%" border="1" bordercolor="#42222A" >
     <tr>
        
        <td bgcolor="#42222A" class="style10 style3"><strong>ID</strong></td>
        <td bgcolor="#42222A" class="style10 style3"><strong>Name</strong></td>
      <td bgcolor="#42222A" class="style10 style3"><strong>Size</strong></td>
        ...
        <td bgcolor="#42222A" class="style10 style3"><strong>Image</strong></td>
        <td bgcolor="#42222A" class="style10 style3"><strong>Delete</strong></td>
      </tr>
      <?php
