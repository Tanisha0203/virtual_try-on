...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <table width="100%" border="1" cellpadding="2" cellspacing="2">
      <tr>
        <td bordercolor="#42222A" bgcolor="#42222A"><span class="style10">ItemName</span></td>
        <td bordercolor="#42222A" bgcolor="#42222A"><span class="style10">Description</span></td>
        <td bordercolor="#42222A" bgcolor="#42222A"><span class="style10">Size</span></td>
        <td bordercolor="#42222A" bgcolor="#42222A"><span class="style10">Image</span></td>
        <td bordercolor="#42222A" bgcolor="#42222A"><span class="style10">Price</span></td>
        <td bordercolor="#42222A" bgcolor="#42222A"><span class="style10">Discount</span></td>
        <td bordercolor="#42222A" bgcolor="#42222A"><span class="style10">Total</span></td>
      </tr>
